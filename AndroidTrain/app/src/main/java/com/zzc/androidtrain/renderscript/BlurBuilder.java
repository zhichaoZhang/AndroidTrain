...
/**
 * 利用RenderScript对图片处理模糊效果
 *
 * Created by zczhang on 16/5/28.
 */
public class BlurBuilder {
    private static final float BLUR_RADIUS =25.f;//模糊半径 0-25

    public static Bitmap blur(Context context, Bitmap sourceBitmap) {
        ...
        Allocation tempIn = Allocation.createFromBitmap(renderScript, sourceBitmap);
...
//        Bitmap bitmap = Bitmap.createScaledBitmap(sbitmap, sbitmap.getWidth() * 1 ,sbitmap.getHeight() * 1,false);//先缩放图片，增加模糊速度
