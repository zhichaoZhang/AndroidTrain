...
public class ObservableNestedScrollView implements Observer, NestedScrollView.OnScrollChangeListener {
  ...
  private void init() {
    if (mNestedScrollView instanceof com.zzc.androidtrain.view.refresh.NestedScrollView) {
      ((com.zzc.androidtrain.view.refresh.NestedScrollView) mNestedScrollView).addOnScrollListener(this);
    } else {
